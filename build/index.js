...
function SiteSearch({
  ...
  const performSearch = query => {
    fetch(`/wp-json/wp/v2/posts?search=${encodeURIComponent(query)}`).then(response => response.json()).then(posts => {
  ...
  // URLが有効ならfetch
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if ((0,_util__WEBPACK_IMPORTED_MODULE_4__.isValidUrl)(url)) {
      fetchData();
    } else {
      setAttributes({
        json: {}
...
function save(props) {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, !isDataEmpty && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...blockProps
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("blockquote", {
    className: "wp-blogcard",
    cite: url
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    className: "wp-blogcard-item",
